...
var UserIndexes []mongo.IndexModel = []mongo.IndexModel{
	{
...
func (uc *UserCollection) AddOwnershipFilters(
	user *schemas.UserRead, findQuery *types_.SearchQuery,
) {
